...
var commandsList = [
	...
	["#C4BAD2",	[	["QT écrit","ecrit",0],
					...
					["J'écris bien comme toi?","bien_comme_toi",0]]	],
	["#D0D0D0", [	["Tu triches", "triche",0],
					["C'est trop facile ?", "facile",0],
					["Pas trop vite", "pas_trop_vite",0],
					["Et boum", "boum",0]	]	],
	["#5CD788", [	["Tu relances ?", "tu_relances",0],
					["Je bugue", "je_bugue",0],
					["Je fatigue", "fatigue",0],
					["Je rouille", "je_rouille",0],
					["Attends", "attends",0],
					["Je suis malade", "malade",0]	]	],
	["#F2838C", [	["Et alors ?", "et_alors",0],
					["J'ai progressé", "jai_progresse",0],
					["C'est difficile", "cest_difficile",0],
					["Je fais des efforts", "fais_mon_mieux",0],
					["C'est bon, t'as gagné", "tas_gagne",0],
					["Ma tablette ?", "ma_tablette",0],
					["C'est pas mal", "pas_mal",0],
					["Je ne trouve pas", "je_trouve_pas",0]	]	],
	["#C0F971", [	["Respire et recommence", "respire",0],	
					["J'ecris mal", "ecris_mal",0],
					["C'est pas grave", "cest_pas_grave",0],
					["Réessayons", "reessayons",0],
					["On fera mieux", "fera_mieux",0],
					["Courage", "courage",0],
					["Nous avons raté", "rate",0],
